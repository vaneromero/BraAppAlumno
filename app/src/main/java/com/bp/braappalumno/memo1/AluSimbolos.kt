...
import com.bp.braappalumno.memo1.AluSimbolos.PreferenceHelper.contador
import com.bp.braappalumno.memo1.AluSimbolos.PreferenceHelper.puntos
import kotlinx.android.synthetic.main.activity_alu_simbolos.*
import kotlinx.android.synthetic.main.activity_alu_simbolos.puntaje
import kotlinx.android.synthetic.main.activity_alu_simbolos.reintentar
...
import kotlinx.android.synthetic.main.ventana_toast1.*
import kotlinx.android.synthetic.main.ventana_toast1.view.texto
import kotlinx.android.synthetic.main.ventana_toast1.view.toastT2
import spencerstudios.com.bungeelib.Bungee
import java.util.*
import kotlin.collections.ArrayList

class AluSimbolos : AppCompatActivity() {
    var marcador: Int=0;
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_alu_simbolos)
        reintentar.setOnClickListener {
            recargar()
        }
        OpcionesJuegos00000.setOnClickListener {
        ...
        val CUSTOM_PREF_NAME = "SimboloAlumno"
    ...
    private fun seleccionLetras() {
        p1=""
        val abc = mutableListOf("arroba","asterisco","barra_vertical","coma","corchete_abrir","corchete_cerrar","diagonal","dividir","doble_flecha","dos_puntos","exponencial","guion_bajo","igual","multiplicar","parentesis_cerrar","parentesis_abrir","punto","punto_coma","resta","signos_admiracion","signos_interrogacion","simbolo_c","suma","numeros")
    ...
    private fun comprobarCorrecto(){
        if(primeraCarta == segundaCarta){
            ...
            a="Los simbolos de las tarjetas no coinciden, por favor intente con otra tarjeta."
            toast1(a)
        }
        im11.isEnabled = true
        im12.isEnabled = true
    ...
    fun mensaje(dato:String) {
        ...
        if(dato.equals("arroba")){
            ...
            dato1="parentesis cerrar"
        }else if(dato.equals("parentesis_abrir")){
            dato1="parentesis abrir"
            ...
            dato1="signos admiracion"
        }else if(dato.equals("signos_interrogacion")){
            dato1="signos interrogacion"
    ...
    private fun toast(ss: String) {
        val customLayout = layoutInflater.inflate(R.layout.ventana_toast1, constraintlayout)
        val toast = Toast(this)
        toast.duration = Toast.LENGTH_LONG
        toast.setGravity(Gravity.CENTER,0,0)
        toast.view = customLayout
        customLayout.texto.text = "Simbolo encontrado"
        customLayout.toastT2.text=ss
        toast.show()
    }
