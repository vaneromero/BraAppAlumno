...
import com.bp.braappalumno.memo1.AluMayusculas.PreferenceHelper.contador
import com.bp.braappalumno.memo1.AluMayusculas.PreferenceHelper.puntos
...
class AluMayusculas : AppCompatActivity() {
    var marcador: Int=0;
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_alu_mayusculas)
        reintentar.setOnClickListener {
            recargar()
        }
        val CUSTOM_PREF_NAME = "MayusculaAlumnos"
        ...
        OpcionesJuegos00.setOnClickListener {
    ...
    private fun seleccionLetras() {
        p1=""
        val abc = mutableListOf("ma","mb","mc","md", "me", "mf", "mg", "mh", "mi", "mj", "mk", "ml", "mm","mn", "n2", "mo", "mp",  "mq", "mr", "ms", "mt", "mu", "mv", "mw", "mx", "my", "mz", "mda", "mda1", "mde", "mdi","mdo","mdo1","mdu","mdu1","mdy")
