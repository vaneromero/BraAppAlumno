...
import com.bp.braappalumno.memo1.AluNumeros.PreferenceHelper.contador
import com.bp.braappalumno.memo1.AluNumeros.PreferenceHelper.puntos
import kotlinx.android.synthetic.main.activity_alu_mayusculas.*
import kotlinx.android.synthetic.main.activity_alu_numeros.*
import kotlinx.android.synthetic.main.activity_alu_numeros.puntaje
import kotlinx.android.synthetic.main.activity_alu_numeros.reintentar
...
class AluNumeros : AppCompatActivity() {
    var marcador: Int=0;
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_alu_numeros)
        reintentar.setOnClickListener {
            recargar()
        }
        OpcionesJuegos0000.setOnClickListener {
        ...
        val CUSTOM_PREF_NAME = "NumerosAlumno"
    ...
    private fun comprobarCorrecto(){
        if(primeraCarta == segundaCarta){
            ...
            a="Los numeros de las tarjetas no coinciden, por favor intente con otra tarjeta."
            toast1(a)
        }
        im11.isEnabled = true
        im12.isEnabled = true
    ...
    private fun toast(s: String) {
        ...
        customLayout.texto.text = "Numero encontrado"
